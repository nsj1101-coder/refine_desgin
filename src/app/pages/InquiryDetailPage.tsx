...
const mockContents: Record<number, { question: string; answer?: string }> = {
  ...
  1: {
    ...
    answer: "첫 방문 시에는 접수 후 전문 상담사와 1:1 상담을 진행하며, 이후 원장님과의 정밀 진단 상담이 이어집니다. 원활한 상담을 위해 사전 예약을 권해드리며, 전화(02-1234-5678) 또는 온라인 예약이 가능합니다. 상담만 받으셔도 부담 없으시니 편하게 방문해 주세요.",
  },
};
