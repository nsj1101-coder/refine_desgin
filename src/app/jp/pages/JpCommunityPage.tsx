...
export default function JpCommunityPage() {
  ...
  const allNotices = [
    ...
    {
      id: 4,
      title: "年末年始の診療時間変更のご案内",
      date: "2023.12.20",
      isNotice: false
    },
    {
      id: 5,
      title: "REFINE クリニック公式ホームページ オープン",
      date: "2023.11.01",
      isNotice: false
    },
    {
      id: 6,
      title: "秋の色素治療で注意すべきことは？",
      date: "2023.10.15",
      isNotice: false
    },
    {
              ...
              <div className="border-t-[2px] border-[#1c1614]">
                {notices.map((notice, idx) => (
                  <FadeInUp key={notice.id} delay={idx * 0.05}>
                    <div
                      onClick={() => navigate(`/jp/community/${notice.id}`)}
