...
export default function JpPromotionPage() {
                ...
                <div className="inline-flex items-center p-1.5 bg-[#f8f5f0] border border-[#e8e5e0] relative">
                  ...
                  >
                    ...
                    <div className="relative z-10 flex items-center gap-3">
                      ...
                      <span className="font-['Pretendard',sans-serif] text-[15px] md:text-[17px] tracking-[-0.02em] font-medium">月間プロモーション</span>
                    </div>
                  </button>
                  <button
                  ...
                  >
                    ...
                    <div className="relative z-10 flex items-center gap-3">
                      ...
                      <span className="font-['Pretendard',sans-serif] text-[15px] md:text-[17px] tracking-[-0.02em] font-medium">スペシャルプロモーション</span>
                    </div>
                  </button>
                </div>
              </div>
            ...
            <div className="flex flex-col gap-[40px] max-w-[1200px] mx-auto">
              {currentEvents.map((event) => (
                <FadeInUp key={event.id}>
                  <div onClick={() => navigate(`/jp/promotion/${event.id}`)} className={`flex flex-col md:flex-row w-full cursor-pointer group transition-colors duration-500 overflow-hidden ${event.isEnded ? 'opacity-60 grayscale' : ''}`}>
