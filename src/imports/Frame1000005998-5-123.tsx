...
function Logo() {
  return (
    <div className="relative shrink-0 h-[50px] w-[330px]" data-name="logo">
      <Group6 />
    </div>
  );
}
...
function LangKr() {
  return (
    <div className="bg-white overflow-clip relative rounded-full shrink-0 size-[34px]" data-name="lang_kr">
...
function Nav() {
  return (
    <div className="flex font-['Montserrat',sans-serif] font-medium gap-[40px] items-center justify-end leading-[normal] relative shrink-0 text-[17px] text-white whitespace-nowrap uppercase" data-name="nav">
      <div className="relative group flex items-center h-full">
        ...
        <div className="absolute top-[100%] left-1/2 -translate-x-1/2 pt-[25px] hidden group-hover:flex flex-col z-[1001]">
          <div className="bg-white content-stretch flex flex-col gap-[4px] items-start leading-[normal] px-[32px] py-[24px] relative size-full whitespace-nowrap shadow-[0_10px_40px_rgba(0,0,0,0.08)] min-w-[220px]">
            <div className="content-stretch flex flex-col gap-[4px] items-start py-[8px] relative shrink-0 w-full group/item cursor-pointer">
      ...
      <div className="relative group flex items-center h-full">
        ...
        <div className="absolute top-[100%] left-1/2 -translate-x-1/2 pt-[25px] hidden group-hover:flex flex-col z-[1001]">
          <div className="bg-white content-stretch flex flex-col gap-[4px] items-start leading-[normal] px-[32px] py-[24px] relative size-full whitespace-nowrap shadow-[0_10px_40px_rgba(0,0,0,0.08)] min-w-[280px]">
            <div className="content-stretch flex flex-col gap-[4px] items-start py-[8px] relative shrink-0 w-full group/item cursor-pointer">
      ...
      <div className="relative group flex items-center h-full">
        ...
        <div className="absolute top-[100%] left-1/2 -translate-x-1/2 pt-[25px] hidden group-hover:flex flex-col z-[1001]">
          <div className="bg-white content-stretch flex flex-col gap-[4px] items-start leading-[normal] px-[32px] py-[24px] relative size-full whitespace-nowrap shadow-[0_10px_40px_rgba(0,0,0,0.08)] min-w-[320px]">
            <div className="content-stretch flex flex-col gap-[4px] items-start py-[8px] relative shrink-0 w-full group/item cursor-pointer">
...
function Frame1() {
  return (
    <div className="flex flex-col gap-[36px] items-end relative shrink-0">
      <Frame />
      <Nav />
    </div>
  );
...
export default function Frame2() {
  return (
    <div className="flex items-end justify-between py-[30px] relative w-full">
      <div aria-hidden="true" className="absolute bottom-0 left-0 right-0 border-[rgba(255,255,255,0.6)] border-b border-solid pointer-events-none" />
      <Group5 />
      <Frame1 />
    </div>
  );
